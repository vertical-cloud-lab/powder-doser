...
PHASE1_EXIT_REMAINING_G = 0.250   # bulk -> fine when <= this many g to go
PHASE2_EXIT_REMAINING_G = 0.025   # fine -> tap  when <= this many g to go
PHASE3_TOLERANCE_G      = 0.001   # done when within +/- this of the goal
...
PHASE1_BULK = {
    "name": "bulk",
    "angle_deg": 25.0,        # "vertical" plate angle -- fast flow
    ...
    "min_gain_g": 0.002,
    "max_stall_cycles": 10,    # 5 dry cycles = empty hopper / jam -> abort
    "stall_nudge_deg": 0.0,
    "max_nudges": 0,
    "max_cycles": 100,
}
...
PHASE2_FINE = {
    ...
    "rotation_deg": 180,     # small auger increment, measure every pause
    "rotation_rpm": 30.0,
    "continuous": 0,
    "poll_ms": 250,
    "anticipation_g": 0.0,
...
PHASE3_TAP = {
    ...
    "rotation_deg": 15.0,      # no auger; taps only
    "rotation_rpm": 0.0,
    "continuous": 0,
    "poll_ms": 250,
    "anticipation_g": 0.0,
