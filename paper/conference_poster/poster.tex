...
\begin{minipage}[c]{0.80\linewidth}
  ...
  {\Large Sam Charles \quad Will Mulberry \quad Luke Winters \quad
   Carl Robinson \quad Gage Erickson \quad Sterling G. Baird}\\[6pt]
...
\begin{minipage}[t]{0.33\linewidth}
  ...
  {\large\texttt{github.com/vertical-cloud-lab/\\powder-doser}}\\[10pt]
  {\normalsize Supported in part by a Utah NASA Space Grant Consortium
