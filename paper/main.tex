...
\small
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lll}
    ...
    Fumed silica & Glidant; neat + 0.5--1 wt\% blends & Flow aid for fine silicon; ultralight, cohesive when neat \\
    \hline
  \end{tabular*}
\end{table*}
