...
rose to tens of milligrams from 20 August. Drift during the second round, in a
different fume hood, was later traced to powder trapped under a misaligned dust
plate on the balance; after cleaning, the balance drifted by less than 0.1~mg
over 16 minutes. All data in the paper predate that fix.
...
\small
\input{figures/data/dose_summary_table}
\normalsize
