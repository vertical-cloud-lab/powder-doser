// ================================================================
// Powder Excavator -- Archimedes Auger TEST PIECE  (nozzle v4)
// ================================================================
//
// Short, gearless test print for nozzle variant 4 from
// vertical-cloud-lab/powder-doser issue #48 comment 4513155870:
//
//   (v4) Continue the screw as the shaft tapers down -- combines v2 and v3.
//
...
//
// Render:
//   openscad -o archimedes-auger-test-nozzle4.stl \
