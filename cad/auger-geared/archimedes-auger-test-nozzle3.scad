// ================================================================
// Powder Excavator -- Archimedes Auger TEST PIECE  (nozzle v3)
// ================================================================
//
// Short, gearless test print for nozzle variant 3 from
// vertical-cloud-lab/powder-doser issue #48 comment 4513155870:
//
//   (v3) Direct cutoff of the screw above a tapered shaft tip that shrinks to a near-point.
//
...
//
// Render:
//   openscad -o archimedes-auger-test-nozzle3.stl \
