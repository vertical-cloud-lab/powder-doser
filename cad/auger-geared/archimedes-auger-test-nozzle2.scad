// ================================================================
// Powder Excavator -- Archimedes Auger TEST PIECE  (nozzle v2)
// ================================================================
//
// Short, gearless test print for nozzle variant 2 from
// vertical-cloud-lab/powder-doser issue #48 comment 4513155870:
//
//   (v2) Continue the screw to just before the exit, straight Ø8 shaft, small short funnel.
//
...
//
// Render:
//   openscad -o archimedes-auger-test-nozzle2.stl \
