...
2160 doses. Grid: powders ['AlSi10Mg', 'lactose', 'salt'], contexts ['nominal', 'stressed'], targets [0.3, 2.0] g, 30 seeds/cell. Tolerance ±5 mg; overshoot = true mass > target (strict). All numbers are true post-settle vial mass; controllers saw only the simulated balance.
